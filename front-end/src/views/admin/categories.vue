                    ...
                    <tbody>
                        <tr v-for="categorie in categories" class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                            ...
                            <td class="px-6 py-4">
                                ...
                                <button @click="modifierCat(categorie.id)" type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Modifier</button>
                            </td>
                        </tr>
                    </tbody>
                </table>
...
<script >
    ...
    methods:{
        ...
        modifierCat(id){
            axios({
                method: 'PATCH',
                url: 'http://127.0.0.1:8000/api/categorie/modifierCat/'+id+'',
                data:{
                    nom:nom
                }
                })
