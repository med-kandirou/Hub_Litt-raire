<template>
    ...
    <div class="">
        <center><button @click="toggle" type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Creer votre groupe</button></center><br>
                ...
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    ...
                    <tbody>
                        <tr v-for="group in groups" class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                            ...
                            <td v-if="group.id_membre==null" class="px-6 py-4">
                            ...
                            <td v-else class="px-6 py-4">
                                <button  @click="discuter(group.id)" type="button" class="text-white bg-gradient-to-r from-blue-800 via-blue-800 to-blue-800 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-800 dark:focus:ring-cyan-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2">Discuter</button>
                            </td>
                        </tr>
                    </tbody>
                </table>
...
export default{
    ...
    methods:{
        discuter(id){
            this.$router.push('/user/groupe/'+id);
        },
        getGroups(){
            axios({
                method: 'GET',
                url: 'http://127.0.0.1:8000/api/user/getGroups/'+this.user.id,
                })
                .then((res) =>{
